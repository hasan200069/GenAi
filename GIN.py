...
def train_model(model, dataloader, epochs=10, plot_interval=20, device='cpu', save_interval=10, save_dir='./model_checkpoints'):
    ...
    for epoch in range(epochs):
        ...
        for step, data in enumerate(dataloader):
            ...
            if (step + 1) % save_interval == 0:
                checkpoint_path = os.path.join(save_dir, f"model_epoch_{epoch+1}_step_{step+1}.pth")
